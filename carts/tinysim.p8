...
function zbuf_draw()
  ...
  if(d.model) collect_drawables(d.model,d.pos,d.m,objs)
 end
...
function collect_drawables(model,pos,m,out)
 -- cam pos in object space
	local cam_pos=make_v(pos,cam.pos)
	m_inv_x_v(m,cam_pos)

  -- transformed vertice cache
	local p={}
  -- faces
  -- todo: face pruning using z-center of face
