...
local wx={
	{name="clear, calm",dir={0,0},ceiling=20000,sky_gradient={0xee,0xffff,0x2e,0xffff,0x11,0xffff}},
  {name="clouds, breezy",dir={60,10},ceiling=500,bkg_color=5,sky_gradient={0x66,0xa5a5,0x65,0xa5a5,0x55,0xa5a5},light_ramp=68,light_dist=12},
...
function trapezefill(l,dl,r,dr,start,finish)
	...
	-- rasterization
	for j=flr(start/2)*2,min(flr(finish/2)*2,40),2 do
		local len=l[5]-l[1]
		if len>0 then
			local w0,u0,v0=l[2],l[3],l[4]
			local dw,du,dv=2*(l[6]-w0)/len,2*(l[7]-u0)/len,2*(l[8]-v0)/len
   -- mipmap
   local m0=shr(mipmaps_c*w0,1)
   local dm=2*(shr(mipmaps_c*l[6],1)-m0)/len
			for i=flr(l[1]/2)*2,flr(l[5]/2)*2,2 do
				-- todo: dm for mipmap selection
				local mipmap=mipmaps[mid(flr(m0),0,mipmaps_c)+1]
				local c=sget(mipmap.x+(u0/w0)%mipmap.w,mipmap.y+(v0/w0)%mipmap.w)
				if(c!=15) rectfill(i,j,i+1,j+1,c)
				u0+=du
				v0+=dv
				w0+=dw
    m0+=dm
...
__gfx__

